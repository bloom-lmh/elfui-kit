...
- ElfUI 组件目录：`Navigation/BackTop`
- Element Plus 文档：`backtop.md`
...
- [x] 2026-07-11 Navigation 第一阶段：复核 Element Plus 核心属性/事件/默认 slot 已覆盖，修正 PropsTable 与 Playground 绑定写法，纳入 Navigation 定向测试和 ui-kit build 验证。
