...
const currentValue = (): TimePickerModelValue => (rangeMode() ? [start.value, end.value] : start.value);
...
const startId = (): string | null => (Array.isArray(props.id) ? props.id[0] || null : props.id || null);
