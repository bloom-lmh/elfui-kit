...
- [ ] P0 补齐核心属性差距：`show-input-controls`、`input-size`、`height`、`aria-label ^ ^`、`range-start-label`、`range-end-label`、`format-value-text`、`tooltip-class`、`placement`、`validate-event`、`persistent ^`、`label ^ ^`
