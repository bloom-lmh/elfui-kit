...
- [ ] P1 补齐核心属性差距：`effect ^`、`confirm-button-text`、`cancel-button-text`、`confirm-button-type`、`cancel-button-type`、`icon`、`icon-color`、`hide-icon`、`hide-after`、`teleported`、`persistent`、`tooltip`
- [ ] P1 补齐事件差距：`confirm`、`cancel`
- [ ] P1 补齐插槽/暴露方法：`reference`、`actions ^`、`popperRef ^`、`hide ^`
